...
var _propTyes = require('prop-types');
...
Hr.propTypes = {
    lineStyle: _propTyes.shape({}),
    text: _propTyes.string,
    marginLeft: _propTyes.number,
    marginRight: _propTyes.number,
    textStyle: _propTyes.shape({})
};
